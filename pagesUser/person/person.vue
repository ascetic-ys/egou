<template>
	<view class="container">
		...
		<view class="list-cell log-out-btn"  @tap="navTo('/pagesUser/person/updatePerson')" v-if="userInfo.tag==1">
			<text class="cell-tit">修改个人信息</text>
		</view>
		<view class="list-cell log-out-btn" @tap="navTo('/pagesUser/person/updatePwd')">
