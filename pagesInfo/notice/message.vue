<template>
	<view class="container">
		<view class="notice-item" @click="navTo('/pagesInfo/notice/messageList?noticeType=1')">
		...
		<view class="notice-item" @click="navTo('/pagesInfo/notice/messageList?noticeType=2')">
		...
		<view class="notice-item" @click="navTo('/pagesInfo/notice/messageList?noticeType=3')">
		...
		<view class="notice-item" @click="navTo('/pagesInfo/notice/messageList?noticeType=4')">
