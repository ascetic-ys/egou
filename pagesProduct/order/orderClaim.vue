	...
	<view class="container">
		...
		<view v-if="!isExist">
			...
			<view class="yt-list">
				...
				<view class="yt-list-cell desc-cell">
					<text class="cell-tit clamp">理赔原因</text>
					<textarea class="desc" v-model="claimReason" placeholder="请填写理赔原因" maxlength="100"/>
				</view>
			</view>
		...
		<view v-if="isExist">
			...
			<view class="yt-list">
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">订单编号</text>
					<text class="cell-tip">{{orderClaim.orderNo}}</text>
				</view>
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">用户名</text>
					<text class="cell-tip">{{orderClaim.userName}}</text>
				</view>
				...
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">申请原因</text>
					<text class="cell-tip">{{orderClaim.applyReason||'-'}}</text>
				</view>
			</view>
			<view class="goods-section">
				<view class="g-header b-b">
					<text class="name">处理信息</text>
				</view>
				
			</view>	
			<view class="yt-list">
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">结论</text>
					<text class="cell-tip">{{orderClaim.claimConclusion||'-'}}</text>
				</view>
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">理赔说明</text>
					<text class="cell-tip">{{orderClaim.claimExplain||'-'}}</text>
				</view>
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">理赔金额</text>
					<text class="cell-tip red">{{orderClaim.claimPrice||'-'}}</text>
				</view>
				
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">处理日期</text>
					<text class="cell-tip">{{orderClaim.claimDate||'-'}}</text>
				</view>
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">处理人</text>
					<text class="cell-tip">{{orderClaim.claimMan||'-'}}</text>
				</view>
				<view class="yt-list-cell b-b">
...
<script>
	...
	export default {
		...
		methods: {
			initData(){
				this.$api.httpPost('claims/api/detail',{orderId:this.id}).then(r=>{
					console.log("请求结果：",r)
					this.orderClaim=r.data
					if(r.data.id){
			...
			async submit(){
				...
				this.$api.httpPost('claims/api/save',this.params).then(r=>{
					console.log('请求结果：',r)
					if(r.code==0){
